        ...
        for capacity in range(1, args.max_capacity + 1):
            ...
            for num_classes in range(1, args.max_num_classes + 1):
                ...
                for iteration in tqdm(range(1, args.num_iter_same_params + 1)):
                    ...
                    full_path = os.path.join(new_folder_name, curr_path)
...
def parse_arguments(argv):
    ...
    parser.add_argument('--num_iter_same_params', type=int, help='max num priority classes', default=25)
    ...
    parser.add_argument('--log_event_path', type=str, help='case number in my settings', default='/scratch/eliransc/inverse_service_sojourn'  )  #r'C:\Users\user\workspace\data\gg1_service_inverse'
