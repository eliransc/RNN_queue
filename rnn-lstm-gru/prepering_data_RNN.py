...
def main(args):
    ...
    path = '/scratch/eliransc/G4_special'
    files = os.listdir(path)
    ...
    for curr_batch in tqdm(range(num_batches)):
        ...
        path_dump = '/scratch/eliransc/rnn_data/gt_gt_1_batches_G4_experiment_special/'
        ...
        pkl.dump((batch_input, batch_output), open(
             os.path.join(path_dump, server_name +'_'+ str(curr_batch) + 'G4_dist_special.pkl'), 'wb'))
