...
def main(args):
    ...
    path = '/scratch/eliransc/testset2'
    files_type_groups = os.listdir(path)

    for type in files_type_groups:
        curr_path = os.path.join(path, type)
        ...
        for curr_batch in tqdm(range(num_batches)):
            ...
            path_dump = '/scratch/eliransc/rnn_data/testset2_batches/'

            curr_dump_path = os.path.join(path_dump, type)
